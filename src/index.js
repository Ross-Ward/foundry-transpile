...
const { emitPHP } = require("./emit/php");
const { emitDart } = require("./emit/dart");
...
const FILE_EXT = { js: "js", python: "py", c: "c", go: "go", java: "java", csharp: "cs", rust: "rs", lua: "lua", kotlin: "kt", zig: "zig", php: "php", dart: "dart" };
